                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <div class="service-item-box service-details-content">
                            <div class="img-box">
                                <img src="assets/imagenes/servicios/serv6G.jpg" alt="Epas Ltda." />
                            </div><!-- /.img-box -->
                            <h3>Reparación de Hormigones</h3>
                            <p>Hemos desarrollado tecnología de punta, junto a técnicas de recuperación de hormigones que aseguran la durabilidad estructural de ellos.</p>
                            <div class="feature-list-box clearfix">
                                <div class="content-box">

                                </div><!-- /.content-box -->
                                <div class="img-box">
                                    <img src="assets/imagenes/servicios/serv6a.jpg" alt="Epas Ltda." />
                                </div><!-- /.img-box -->
