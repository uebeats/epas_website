...
try {
    document.domain = "corzan.com";
} catch (e) {
    if (window.console) {console.log("Unable to set domain "+document.location.hostname+" to corzan.com");}
}
...
if ((window.console)&&((copyrightDisplay=="true")||(copyrightDisplay=="modest"))) {console.log("Production™ Framework v3.191 loaded.\n© 2016. All rights reserved IMPACT Branding & Design LLC.\nhttp://www.impactbnd.com");}
...
*//*
@codekit-append "../../Deli_Assets/base/JS/_mixitup.js"
*//*
...
if ((window.console)&&(copyrightDisplay=="true")) {console.log("Script loaded: mixitup.js");}
		...
		_bindHandlers: function(){
			...
			if(self.controls.live){
				...
				self._$filterButtons.on('click.mixItUp.'+self._id, function(){
					if ($('.mixitup-header').length>0) {$('.mixitup-header').html($(this).html())}
					self._processClick($(this), 'filter');
				});
			}
